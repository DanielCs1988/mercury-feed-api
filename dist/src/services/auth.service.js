...
class AuthService {
    constructor() {
        ...
        this.getCurrentUserId = (req, res, next, prisma) => __awaiter(this, void 0, void 0, function* () {
            if (req.user) {
                req.userId = yield this.fetchUserId(prisma, req.user.sub, req.headers.authorization);
                next();
            }
        });
        this.getUserIdFromToken = (token, context) => __awaiter(this, void 0, void 0, function* () {
            if (!token) {
